...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { corpo: @notice.corpo, criacao: @notice.criacao, titulo: @notice.titulo } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { corpo: @notice.corpo, criacao: @notice.criacao, titulo: @notice.titulo } }
